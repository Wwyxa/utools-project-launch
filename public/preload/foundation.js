...
const projectLaunchServiceSyncResponseLimitBytes = 512 * 1024;
...
const gitActivityCacheLimit = 20;
const gitActivityCacheTtlMs = 5 * 60 * 1000;
const gitActivityReadTimeoutMs = 60 * 1000;
const gitActivityChangesCache = new Map();
const gitActivityChangesCacheLimit = 12;
const gitActivityDayCache = new Map();
const gitActivityDayCacheVersions = new Map();
const gitActivityDayCacheLimit = 32;
const gitActivityDayCacheRecordLimit = 500;
const gitActivityDayPageLimit = 50;
const gitRemoteProgressDispatchIntervalMs = 60;
const gitRemoteProgressQueueLimit = 16;
