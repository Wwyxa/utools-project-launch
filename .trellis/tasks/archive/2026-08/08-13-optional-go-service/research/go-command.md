...
This package is not in the latest version of its module.
   ...
   [Go to latest](/cmd/go)     Published: Jul 7, 2026   License: [BSD-3-Clause](/cmd/go?tab=licenses) 

Opens a new window with license information.

  [Imports: 37](/cmd/go?tab=imports)  

Opens a new window with list of imports.

  [Imported by: 4](/cmd/go?tab=importedby)  
...
* [Start a bug report](#hdr-Start_a_bug_report)
* [Compile packages and dependencies](#hdr-Compile_packages_and_dependencies)
* [Remove object files and cached files](#hdr-Remove_object_files_and_cached_files)
* [Show documentation for package or symbol](#hdr-Show_documentation_for_package_or_symbol)
* [Print Go environment information](#hdr-Print_Go_environment_information)
* [Apply fixes suggested by static checkers](#hdr-Apply_fixes_suggested_by_static_checkers)
* [Gofmt (reformat) package sources](#hdr-Gofmt__reformat__package_sources)
* [Generate Go files by processing source](#hdr-Generate_Go_files_by_processing_source)
* [Add dependencies to current module and install them](#hdr-Add_dependencies_to_current_module_and_install_them)
* [Compile and install packages and dependencies](#hdr-Compile_and_install_packages_and_dependencies)
* [List packages or modules](#hdr-List_packages_or_modules)
* [Module maintenance](#hdr-Module_maintenance)
* [Download modules to local cache](#hdr-Download_modules_to_local_cache)
* [Edit go.mod from tools or scripts](#hdr-Edit_go_mod_from_tools_or_scripts)
* [Print module requirement graph](#hdr-Print_module_requirement_graph)
* [Initialize new module in current directory](#hdr-Initialize_new_module_in_current_directory)
* [Add missing and remove unused modules](#hdr-Add_missing_and_remove_unused_modules)
* [Make vendored copy of dependencies](#hdr-Make_vendored_copy_of_dependencies)
* [Verify dependencies have expected content](#hdr-Verify_dependencies_have_expected_content)
* [Explain why packages or modules are needed](#hdr-Explain_why_packages_or_modules_are_needed)
* [Workspace maintenance](#hdr-Workspace_maintenance)
* [Edit go.work from tools or scripts](#hdr-Edit_go_work_from_tools_or_scripts)
* [Initialize workspace file](#hdr-Initialize_workspace_file)
* [Sync workspace build list to modules](#hdr-Sync_workspace_build_list_to_modules)
* [Add modules to workspace file](#hdr-Add_modules_to_workspace_file)
* [Make vendored copy of dependencies](#hdr-Make_vendored_copy_of_dependencies-1)
* [Compile and run Go program](#hdr-Compile_and_run_Go_program)
* [Manage telemetry data and settings](#hdr-Manage_telemetry_data_and_settings)
* [Test packages](#hdr-Test_packages)
* [Run specified go tool](#hdr-Run_specified_go_tool)
* [Print Go version](#hdr-Print_Go_version)
* [Report likely mistakes in packages](#hdr-Report_likely_mistakes_in_packages)
* [Build constraints](#hdr-Build_constraints)
* [Build -json encoding](#hdr-Build__json_encoding)
* [Build modes](#hdr-Build_modes)
* [Calling between Go and C](#hdr-Calling_between_Go_and_C)
* [Build and test caching](#hdr-Build_and_test_caching)
* [Environment variables](#hdr-Environment_variables)
* [File types](#hdr-File_types)
* [GOAUTH environment variable](#hdr-GOAUTH_environment_variable)
* [The go.mod file](#hdr-The_go_mod_file)
* [GOPATH environment variable](#hdr-GOPATH_environment_variable)
* [GOPATH and Modules](#hdr-GOPATH_and_Modules)
* [Internal Directories](#hdr-Internal_Directories)
* [Vendor Directories](#hdr-Vendor_Directories)
* [Module proxy protocol](#hdr-Module_proxy_protocol)
* [Import path syntax](#hdr-Import_path_syntax)
* [Relative import paths](#hdr-Relative_import_paths)
* [Remote import paths](#hdr-Remote_import_paths)
* [Import path checking](#hdr-Import_path_checking)
* [Modules, module versions, and more](#hdr-Modules__module_versions__and_more)
* [Module authentication using go.sum](#hdr-Module_authentication_using_go_sum)
* [Package lists and patterns](#hdr-Package_lists_and_patterns)
* [Configuration for downloading non-public code](#hdr-Configuration_for_downloading_non_public_code)
* [Testing flags](#hdr-Testing_flags)
* [Testing functions](#hdr-Testing_functions)
* [Controlling version control with GOVCS](#hdr-Controlling_version_control_with_GOVCS)
...
#### Start a bug report [¶](#hdr-Start_a_bug_report "Go to Start a bug report")
...
#### Compile packages and dependencies [¶](#hdr-Compile_packages_and_dependencies "Go to Compile packages and dependencies")
...
#### Remove object files and cached files [¶](#hdr-Remove_object_files_and_cached_files "Go to Remove object files and cached files")
...
#### Show documentation for package or symbol [¶](#hdr-Show_documentation_for_package_or_symbol "Go to Show documentation for package or symbol")
...
#### Print Go environment information [¶](#hdr-Print_Go_environment_information "Go to Print Go environment information")
...
#### Apply fixes suggested by static checkers [¶](#hdr-Apply_fixes_suggested_by_static_checkers "Go to Apply fixes suggested by static checkers")
...
#### Gofmt (reformat) package sources [¶](#hdr-Gofmt__reformat__package_sources "Go to Gofmt (reformat) package sources")
...
#### Generate Go files by processing source [¶](#hdr-Generate_Go_files_by_processing_source "Go to Generate Go files by processing source")
...
#### Add dependencies to current module and install them [¶](#hdr-Add_dependencies_to_current_module_and_install_them "Go to Add dependencies to current module and install them")
...
#### Compile and install packages and dependencies [¶](#hdr-Compile_and_install_packages_and_dependencies "Go to Compile and install packages and dependencies")
...
Executables are installed in the directory named by the GOBIN environment variable, which defaults to $GOPATH/bin or $HOME/go/bin if the GOPATH environment variable is not set. Executables in $GOROOT are installed in $GOROOT/bin or $GOTOOLDIR instead of $GOBIN. Cross compiled binaries are installed in $GOOS\_$GOARCH subdirectories of the above.
...
When module-aware mode is disabled, non-main packages are installed in the directory $GOPATH/pkg/$GOOS\_$GOARCH. When module-aware mode is enabled, non-main packages are built and cached but not installed.

Before Go 1.20, the standard library was installed to $GOROOT/pkg/$GOOS\_$GOARCH. Starting in Go 1.20, the standard library is built and cached but not installed. Setting GODEBUG=installgoroot=all restores the use of $GOROOT/pkg/$GOOS\_$GOARCH.
...
#### List packages or modules [¶](#hdr-List_packages_or_modules "Go to List packages or modules")
...
#### Module maintenance [¶](#hdr-Module_maintenance "Go to Module maintenance")
...
#### Download modules to local cache [¶](#hdr-Download_modules_to_local_cache "Go to Download modules to local cache")
...
#### Edit go.mod from tools or scripts [¶](#hdr-Edit_go_mod_from_tools_or_scripts "Go to Edit go.mod from tools or scripts")
...
#### Print module requirement graph [¶](#hdr-Print_module_requirement_graph "Go to Print module requirement graph")
...
#### Initialize new module in current directory [¶](#hdr-Initialize_new_module_in_current_directory "Go to Initialize new module in current directory")
...
#### Add missing and remove unused modules [¶](#hdr-Add_missing_and_remove_unused_modules "Go to Add missing and remove unused modules")
...
#### Make vendored copy of dependencies [¶](#hdr-Make_vendored_copy_of_dependencies "Go to Make vendored copy of dependencies")
...
#### Verify dependencies have expected content [¶](#hdr-Verify_dependencies_have_expected_content "Go to Verify dependencies have expected content")
...
#### Explain why packages or modules are needed [¶](#hdr-Explain_why_packages_or_modules_are_needed "Go to Explain why packages or modules are needed")
...
#### Workspace maintenance [¶](#hdr-Workspace_maintenance "Go to Workspace maintenance")
...
#### Edit go.work from tools or scripts [¶](#hdr-Edit_go_work_from_tools_or_scripts "Go to Edit go.work from tools or scripts")
...
#### Initialize workspace file [¶](#hdr-Initialize_workspace_file "Go to Initialize workspace file")
...
#### Sync workspace build list to modules [¶](#hdr-Sync_workspace_build_list_to_modules "Go to Sync workspace build list to modules")
...
#### Add modules to workspace file [¶](#hdr-Add_modules_to_workspace_file "Go to Add modules to workspace file")
...
#### Make vendored copy of dependencies [¶](#hdr-Make_vendored_copy_of_dependencies-1 "Go to Make vendored copy of dependencies")
...
#### Compile and run Go program [¶](#hdr-Compile_and_run_Go_program "Go to Compile and run Go program")
...
If the -exec flag is not given, GOOS or GOARCH is different from the system default, and a program named go\_$GOOS\_$GOARCH\_exec can be found on the current search path, 'go run' invokes the binary using that program, for example 'go\_js\_wasm\_exec a.out arguments...'. This allows execution of cross-compiled programs when a simulator or other execution method is available.
...
#### Manage telemetry data and settings [¶](#hdr-Manage_telemetry_data_and_settings "Go to Manage telemetry data and settings")
...
#### Test packages [¶](#hdr-Test_packages "Go to Test packages")
...
#### Run specified go tool [¶](#hdr-Run_specified_go_tool "Go to Run specified go tool")
...
For more about each builtin tool command, see 'go doc cmd/'.

#### Print Go version [¶](#hdr-Print_Go_version "Go to Print Go version")
...
#### Report likely mistakes in packages [¶](#hdr-Report_likely_mistakes_in_packages "Go to Report likely mistakes in packages")
...
#### Build constraints [¶](#hdr-Build_constraints "Go to Build constraints")
...
* "cgo", if the cgo command is supported (see CGO\_ENABLED in 'go help environment').
...
(example: source\_windows\_amd64.go) where GOOS and GOARCH represent any known operating system and architecture values respectively, then the file is considered to have an implicit build constraint requiring those terms (in addition to any explicit constraints in the file).
...
Naming a file dns\_windows.go will cause it to be included only when building the package for Windows; similarly, math\_386.s will be included only when building the package for 32-bit x86.
...
#### Build -json encoding [¶](#hdr-Build__json_encoding "Go to Build -json encoding")
...
```
type BuildEvent struct { ImportPath string Action string Output string } 
```
...
```
build-output - The toolchain printed output build-fail - The build failed 
```
...
#### Build modes [¶](#hdr-Build_modes "Go to Build modes")
...
#### Calling between Go and C [¶](#hdr-Calling_between_Go_and_C "Go to Calling between Go and C")
...
The second is the SWIG program, which is a general tool for interfacing between languages. For information on SWIG see <https://swig.org/>. When running go build, any file with a .swig extension will be passed to SWIG. Any file with a .swigcxx extension will be passed to SWIG with the -c++ option. A package can't be just a .swig or .swigcxx file; there must be at least one .go file, even if it has just a package clause.
...
#### Build and test caching [¶](#hdr-Build_and_test_caching "Go to Build and test caching")
...
#### Environment variables [¶](#hdr-Environment_variables "Go to Environment variables")
...
#### GOAUTH environment variable [¶](#hdr-GOAUTH_environment_variable "Go to GOAUTH environment variable")
...
```
Runs 'git credential fill' in dir and uses its credentials. The go command will run 'git credential approve/reject' to update the credential helper's cache. 
```

command

```
Executes the given command (a space-separated argument list) and attaches the provided headers to HTTPS requests. The command must produce output in the following format: Response = { CredentialSet } . CredentialSet = URLLine { URLLine } BlankLine { HeaderLine } BlankLine . URLLine = /* URL that starts with "https://" */ '\n' . HeaderLine = /* HTTP Request header */ '\n' . BlankLine = '\n' . Example: https://example.com https://example.net/api/ Authorization: Basic  https://another-example.org/ Example: Data If the server responds with any 4xx code, the go command will write the following to the program's stdin: Response = StatusLine { HeaderLine } BlankLine . StatusLine = Protocol Space Status '\n' . Protocol = /* HTTP protocol */ . Space = ' ' . Status = /* HTTP status code */ . BlankLine = '\n' . HeaderLine = /* HTTP Response's header */ '\n' . Example: HTTP/1.1 401 Unauthorized Content-Length: 19 Content-Type: text/plain; charset=utf-8 Date: Thu, 07 Nov 2024 18:43:09 GMT Note: it is safe to use net/http.ReadResponse to parse this input. 
```
...
#### The go.mod file [¶](#hdr-The_go_mod_file "Go to The go.mod file")
...
#### GOPATH environment variable [¶](#hdr-GOPATH_environment_variable "Go to GOPATH environment variable")
...
If DIR is a directory listed in the GOPATH, a package with source in DIR/src/foo/bar can be imported as "foo/bar" and has its compiled form installed to "DIR/pkg/GOOS\_GOARCH/foo/bar.a".
...
#### GOPATH and Modules [¶](#hdr-GOPATH_and_Modules "Go to GOPATH and Modules")

When using modules, GOPATH is no longer used for resolving imports. However, it is still used to store downloaded source code (in GOPATH/pkg/mod) and compiled commands (in GOPATH/bin).

#### Internal Directories [¶](#hdr-Internal_Directories "Go to Internal Directories")
...
#### Vendor Directories [¶](#hdr-Vendor_Directories "Go to Vendor Directories")
...
#### Module proxy protocol [¶](#hdr-Module_proxy_protocol "Go to Module proxy protocol")
...
#### Import path syntax [¶](#hdr-Import_path_syntax "Go to Import path syntax")
...
#### Relative import paths [¶](#hdr-Relative_import_paths "Go to Relative import paths")
...
#### Remote import paths [¶](#hdr-Remote_import_paths "Go to Remote import paths")
...
By default, downloads are restricted to known secure protocols (e.g. https, ssh). To override this setting for Git downloads, the GIT\_ALLOW\_PROTOCOL environment variable can be set (For more details see: 'go help environment').
...
Downloaded packages are stored in the module cache. See <https://golang.org/ref/mod#module-cache>.
...
#### Import path checking [¶](#hdr-Import_path_checking "Go to Import path checking")
...
#### Modules, module versions, and more [¶](#hdr-Modules__module_versions__and_more "Go to Modules, module versions, and more")
...
#### Module authentication using go.sum [¶](#hdr-Module_authentication_using_go_sum "Go to Module authentication using go.sum")
...
#### Package lists and patterns [¶](#hdr-Package_lists_and_patterns "Go to Package lists and patterns")
...
#### Configuration for downloading non-public code [¶](#hdr-Configuration_for_downloading_non_public_code "Go to Configuration for downloading non-public code")
...
#### Testing functions [¶](#hdr-Testing_functions "Go to Testing functions")
...
#### Controlling version control with GOVCS [¶](#hdr-Controlling_version_control_with_GOVCS "Go to Controlling version control with GOVCS")
...
[View all Source files](https://cs.opensource.google/go/go/+/go1.26.5:src/cmd/go)

* [alldocs.go](https://cs.opensource.google/go/go/+/go1.26.5:src/cmd/go/alldocs.go "alldocs.go")
* [go11.go](https://cs.opensource.google/go/go/+/go1.26.5:src/cmd/go/go11.go "go11.go")
* [main.go](https://cs.opensource.google/go/go/+/go1.26.5:src/cmd/go/main.go "main.go")
...
| --- | --- |
| internal |
| [auth](/cmd/go/internal/auth@go1.26.5)  Package auth provides access to user-provided authentication credentials. | Package auth provides access to user-provided authentication credentials. |
| [base](/cmd/go/internal/base@go1.26.5)  Package base defines shared basic pieces of the go command, in particular logging and the Command structure. | Package base defines shared basic pieces of the go command, in particular logging and the Command structure. |
| [bug](/cmd/go/internal/bug@go1.26.5)  Package bug implements the “go bug” command. | Package bug implements the “go bug” command. |
| [cache](/cmd/go/internal/cache@go1.26.5)  Package cache implements a build artifact cache. | Package cache implements a build artifact cache. |
| [cacheprog](/cmd/go/internal/cacheprog@go1.26.5)  Package cacheprog defines the protocol for a GOCACHEPROG program. | Package cacheprog defines the protocol for a GOCACHEPROG program. |
| [cfg](/cmd/go/internal/cfg@go1.26.5)  Package cfg holds configuration shared by multiple parts of the go command. | Package cfg holds configuration shared by multiple parts of the go command. |
| [clean](/cmd/go/internal/clean@go1.26.5)  Package clean implements the “go clean” command. | Package clean implements the “go clean” command. |
| [cmdflag](/cmd/go/internal/cmdflag@go1.26.5)  Package cmdflag handles flag processing common to several go tools. | Package cmdflag handles flag processing common to several go tools. |
| [doc](/cmd/go/internal/doc@go1.26.5)  Package doc implements the “go doc” command. | Package doc implements the “go doc” command. |
| [envcmd](/cmd/go/internal/envcmd@go1.26.5)  Package envcmd implements the “go env” command. | Package envcmd implements the “go env” command. |
| [fips140](/cmd/go/internal/fips140@go1.26.5)  Package fips implements support for the GOFIPS140 build setting. | Package fips implements support for the GOFIPS140 build setting. |
| [fmtcmd](/cmd/go/internal/fmtcmd@go1.26.5)  Package fmtcmd implements the “go fmt” command. | Package fmtcmd implements the “go fmt” command. |
| [fsys](/cmd/go/internal/fsys@go1.26.5)  Package fsys implements a virtual file system that the go command uses to read source file trees. | Package fsys implements a virtual file system that the go command uses to read source file trees. |
| [generate](/cmd/go/internal/generate@go1.26.5)  Package generate implements the “go generate” command. | Package generate implements the “go generate” command. |
| [gover](/cmd/go/internal/gover@go1.26.5)  Package gover implements support for Go toolchain versions like 1.21.0 and 1.21rc1. | Package gover implements support for Go toolchain versions like 1.21.0 and 1.21rc1. |
| [help](/cmd/go/internal/help@go1.26.5)  Package help implements the “go help” command. | Package help implements the “go help” command. |
|  |
| [list](/cmd/go/internal/list@go1.26.5)  Package list implements the “go list” command. | Package list implements the “go list” command. |
| [load](/cmd/go/internal/load@go1.26.5)  Package load loads packages. | Package load loads packages. |
| [lockedfile](/cmd/go/internal/lockedfile@go1.26.5)  Package lockedfile creates and manipulates files whose contents should only change atomically. | Package lockedfile creates and manipulates files whose contents should only change atomically. |
| [lockedfile/internal/filelock](/cmd/go/internal/lockedfile/internal/filelock@go1.26.5)  Package filelock provides a platform-independent API for advisory file locking. | Package filelock provides a platform-independent API for advisory file locking. |
| [mmap](/cmd/go/internal/mmap@go1.26.5)  The mmap package provides an abstraction for memory mapping files on different platforms. | The mmap package provides an abstraction for memory mapping files on different platforms. |
| [modcmd](/cmd/go/internal/modcmd@go1.26.5)  Package modcmd implements the “go mod” command. | Package modcmd implements the “go mod” command. |
|  |
| [modfetch/codehost](/cmd/go/internal/modfetch/codehost@go1.26.5)  Package codehost defines the interface implemented by a code hosting source, along with support code for use by implementations. | Package codehost defines the interface implemented by a code hosting source, along with support code for use by implementations. |
| [modget](/cmd/go/internal/modget@go1.26.5)  Package modget implements the module-aware “go get” command. | Package modget implements the module-aware “go get” command. |
|  |
|  |
|  |
| [mvs](/cmd/go/internal/mvs@go1.26.5)  Package mvs implements Minimal Version Selection. | Package mvs implements Minimal Version Selection. |
| [run](/cmd/go/internal/run@go1.26.5)  Package run implements the “go run” command. | Package run implements the “go run” command. |
|  |
| [str](/cmd/go/internal/str@go1.26.5)  Package str provides string manipulation utilities. | Package str provides string manipulation utilities. |
| [telemetrycmd](/cmd/go/internal/telemetrycmd@go1.26.5)  Package telemetrycmd implements the "go telemetry" command. | Package telemetrycmd implements the "go telemetry" command. |
|  |
|  |
|  |
| [tool](/cmd/go/internal/tool@go1.26.5)  Package tool implements the “go tool” command. | Package tool implements the “go tool” command. |
| [toolchain](/cmd/go/internal/toolchain@go1.26.5)  Package toolchain implements dynamic switching of Go toolchains. | Package toolchain implements dynamic switching of Go toolchains. |
|  |
|  |
| [vcweb](/cmd/go/internal/vcweb@go1.26.5)  Package vcweb serves version control repos for testing the go command. | Package vcweb serves version control repos for testing the go command. |
| [vcweb/vcstest](/cmd/go/internal/vcweb/vcstest@go1.26.5)  Package vcstest serves the repository scripts in cmd/go/testdata/vcstest using the vcweb script engine. | Package vcstest serves the repository scripts in cmd/go/testdata/vcstest using the vcweb script engine. |
| [version](/cmd/go/internal/version@go1.26.5)  Package version implements the “go version” command. | Package version implements the “go version” command. |
| [vet](/cmd/go/internal/vet@go1.26.5)  Package vet implements the “go vet” and “go fix” commands. | Package vet implements the “go vet” and “go fix” commands. |
| [web](/cmd/go/internal/web@go1.26.5)  Package web defines minimal helper routines for accessing HTTP/HTTPS resources without requiring external dependencies on the net package. | Package web defines minimal helper routines for accessing HTTP/HTTPS resources without requiring external dependencies on the net package. |
|  |
|  |
| [workcmd](/cmd/go/internal/workcmd@go1.26.5)  Package workcmd implements the “go work” command. | Package workcmd implements the “go work” command. |
